import re, sys, os
from .nodes import GroupNode, PythonNode, TextNode, IfNode
    ...
    while pos < len(token_list):
        ...
        if t['label'] == "python":
            ...
            if parent_type == "if":
                ...
                raise TemplateException("Unexpected end of 'if' tag.")
        elif t['label'] == 'for':
            new_node = ForNode(**t['expr'])
            parent.add(new_node)
            pos += 1
            ...
            if parent_type == "for":
                ...
                raise TemplateException("Unexpected end of 'for' tag.")
        elif t['label'] == "html":
